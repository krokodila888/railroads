...
const TableRow: FC<TProps> = ({
  ...
  //пользователь может ввести невалидные данные множеством способов даже при ограничениях в инпутах. Тут можно предотвратить некоторые из них: добавление математических знаков и разрешенных переменных (как e) в середину значения
  //можно заблокировать тут возможность ввода отрицательных чисел. Ограничивать число знаков до/после запятой таким способом можно, но так пользователь может пропустить свою ошибку, если приложение будет првить все за него и показывать валидный инпут
